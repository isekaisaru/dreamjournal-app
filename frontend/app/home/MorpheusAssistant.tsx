...
const getGreeting = (isFirstVisit: boolean) => {
  if (isFirstVisit) {
    return {
      title: "はじめまして、夢の番人です。",
      message:
        "ぼくは モルペウス。きみの ゆめの せかいを あんないするよ。みた ゆめを ぼくに はなしてくれないかな？",
    };
  }
  ...
  if (hour >= 4 && hour < 10) {
    ...
    return {
      title: "おはようございます！",
      message: "ゆうべは いいゆめが みられたかな？ わすれないうちに きろくしておこう。",
    };
  }
  if (hour >= 10 && hour < 18) {
    // 昼 10:00 ~ 17:59
    return {
      title: "こんにちは！",
      message: "ゆめは、きみの こころを うつす かがみ かもしれないね。なにか きづいたことは あったかな？",
    };
  }
  if (hour >= 18 && hour < 22) {
    // 夜 18:00 ~ 21:59
    return {
      title: "こんばんは。",
      message: "きょうも いちにち、おつかれさま。こんや みる ゆめが たのしみだね。",
    };
  }
  // 深夜 22:00 ~ 3:59
  return {
    title: "おやすみなさい…",
    message: "いいゆめを。また あした、きみの ゆめの おはなしを きかせてね。",
  };
};
