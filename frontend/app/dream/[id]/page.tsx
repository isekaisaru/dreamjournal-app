...
export default function EditDreamPage() {
  ...
  const updateDream = async (updatedData: { title: string; description: string }) => {
    setIsLoading(true);
    try {
      await axios.put(`${process.env.NEXT_PUBLIC_API_URL}/dreams/${id}`, updatedData);
      router.push("/home");
    } catch (error) {
  ...
  return (
    <div className="min-h-screen py-8 px-4 md:px-12">
      ...
      <DreamForm initialData={dream} onSubmit={updateDream} isLoading={isLoading} />
