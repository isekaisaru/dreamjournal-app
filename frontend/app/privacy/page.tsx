        ...
        <div className="prose prose-lg max-w-none space-y-8">
          ...
          <section>
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
              <h3 className="font-semibold text-gray-900 mb-2">当サービスで集める情報：</h3>
              <ul className="list-disc list-inside space-y-2 text-gray-700">
                <li><strong>メールアドレス</strong>: ログインするために使います</li>
                <li><strong>パスワード</strong>: 安全に暗号化して保存します</li>
                <li><strong>夢の記録</strong>: タイトル、内容、感情タグ、記録した日時</li>
                <li><strong>利用状況</strong>: いつログインしたか、どのページを見たかなど</li>
              </ul>
            </div>
          </section>
            ...
            <div className="space-y-3 text-gray-700">
              ...
              <div className="grid md:grid-cols-2 gap-4 mt-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm">夢の分析機能で使用。夢の内容を送信しますが、OpenAIは学習には使いません。</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold mb-2">📊 Sentry</h4>
                  <p className="text-sm">エラー監視で使用。エラー発生時の情報のみを送信します。</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold mb-2">🗄️ Supabase</h4>
                  <p className="text-sm">データベースサービス。すべてのデータを安全に保存します。</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold mb-2">☁️ Vercel / Render</h4>
                  <p className="text-sm">サーバーサービス。アプリの動作に必要です。</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="bg-purple-50 border-l-4 border-purple-500 p-4 rounded">
              <p className="text-gray-700 mb-2">みなさまの情報を守るために、以下の対策をしています：</p>
              <ul className="list-disc list-inside space-y-2 text-gray-700 text-sm ml-4">
                <li><strong>パスワードの暗号化</strong>: パスワードは誰にも見えない形で保存</li>
                <li><strong>通信の暗号化</strong>: HTTPS（鍵マーク🔒）で安全に通信</li>
                <li><strong>データベースの保護</strong>: 許可された人だけがアクセス可能</li>
                <li><strong>エラー監視</strong>: 24時間体制で問題を検知</li>
              </ul>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-500 p-4 rounded">
              <p className="text-gray-700">
                ...
                <strong>13歳未満のお子さまが使う場合は、保護者の方の同意が必要です。</strong>
              </p>
              <p className="text-sm text-gray-600 mt-2">
                ※ 保護者の方へ: お子さまの夢の記録は、お子さまの心の成長を見守るためのものです。
                安心してご利用ください。
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-2 text-gray-700">
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li><strong>夢の記録</strong>: アカウント削除まで永久保存</li>
                <li><strong>ログイン情報</strong>: アカウント削除まで保存</li>
                <li><strong>エラーログ</strong>: 最大90日間</li>
              </ul>
            </div>
          </section>
