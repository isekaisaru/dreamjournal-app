...
export default function TrialPage() {
  ...
  const [dreams, setDreams] = useState<{ title: string; description: string }[]>([]);
    ...
    <div className="container mx-auto p-4">
      ...
      {userId && (
        <div className="mt-6">
          ...
          >
            <div className="mb-4">
              <label htmlFor="title" className="block text-sm font-medium text-gray-700">夢のタイトル:</label>
              <input
                id="title"
                name="title"
                type="text"
            ...
            <div className="mb-4">
              <label htmlFor="description" className="block text-sm font-medium text-gray-700">夢の内容:</label>
              <textarea
                id="description"
                name="description"
                value={description}
