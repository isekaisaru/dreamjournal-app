...
import { Sparkles, Mic, Brain, ImageIcon, ChevronDown, Lock } from "lucide-react";
          ...
          <div className="space-y-8">
            ...
            <motion.div variants={fadeIn} custom={4} className="flex items-start gap-4">
              <div className="flex-shrink-0 w-10 h-10 rounded-xl bg-amber-500/15 flex items-center justify-center">
                <ImageIcon className="text-amber-500 dark:text-amber-400" size={20} />
              </div>
              <div>
        ...
        >
          ...
          <dl className="space-y-3">
            {FAQ_ITEMS.map((item, i) => (
              ...
              >
                {/* dt が button を包む（有効なHTMLセマンティクス） */}
                <dt>
                  <button
                    type="button"
